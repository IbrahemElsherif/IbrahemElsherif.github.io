...
export function IconLinkedIn({ className, size = 18 }: IconProps) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M4.98 3.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zM3 9h4v12H3zM9 9h3.8v1.71h.05c.53-.95 1.83-1.96 3.77-1.96 4.03 0 4.78 2.5 4.78 5.75V21h-4v-5.13c0-1.22-.02-2.8-1.78-2.8-1.78 0-2.05 1.34-2.05 2.71V21H9z" />
    </svg>
  );
}
